...
const questions = [
    ...
    { text: "Invite another participant to respond to this message and continue.", agreeAudio: "sounds/agree2.mp3", disagreeAudio: "sounds/disagree3.mp3", backgroundImage: "images/background7.jpg" },
    ...
    { text: "Create a little conducting piece: when you raise your hands, everybody shouts. When your hands are down, everybody is quite. You can play with that and create dynamics, new sounds… Enjoy!", agreeAudio: "sounds/agree4.mp3", disagreeAudio: "sounds/disagree3.mp3", backgroundImage: "images/background9.jpg" },
...
window.onload = function() {
    preloadImages();
    document.getElementById('question').innerHTML = questions[0].text; 
    changeBackground(questions[0].backgroundImage); 
};
